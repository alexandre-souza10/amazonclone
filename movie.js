...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=b8a56ca9ea7bf469c527a001fc424d86&language=en-US&page=1')
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=b8a56ca9ea7bf469c527a001fc424d86&language=en-US&page=2')
.then(response => response.json())
.then(data =>{
 data.results.map((i, j) => {
 if(j > 18)
...
fetch('https://api.themoviedb.org/3/movie/popular?api_key=b8a56ca9ea7bf469c527a001fc424d86&language=en-US&page=3')
.then(response => response.json())
.then(data =>{
 data.results.map((i, j) => {
 if(j > 18)
